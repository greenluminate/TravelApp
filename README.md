...
```
cd existing_repo
git remote add origin https://gitlab.com/epam-hu-universities/java-enterprise/travel/travel-phase-2.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/epam-hu-universities/java-enterprise/travel/travel-phase-2/-/settings/integrations)
